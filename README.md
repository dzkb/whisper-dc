...
The speech-to-text model used is a pre-trained [OpenAI's Whisper](https://github.com/openai/whisper) model (specifically [`large V3`](https://huggingface.co/openai/whisper-large-v3)), ran with whisper.cpp through [pywhispercpp](https://github.com/absadiki/pywhispercpp)
...
- `MODEL_NAME` - the name of the model to be loaded by `whisper.cpp` from Hugging Face Hub. Refer to the original repository to learn more about available pre-trained models. Default: `large-v3-turbo-q8_0`
